                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <button className="btn btn-primary w-100 mb-4">
                               <span className="fa fa-google me-2"></span> Faça login com o Google
                            </button>
                            <button className="btn btn-primary w-100 mb-4">
                               <span className="fa fa-facebook me-2"></span> Faça login com o Facebook
                            </button>
                            <form>
                                <div className="mb-3">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="mb-3 form-check">
                                            ...
                                            <button type="submit" className="btn btn-outline-primary w-100 mt-5">Enviar</button>
</form>
                                    </div>
                                </div>
                </div>
